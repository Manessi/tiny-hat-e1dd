...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/tiny-hat-e1dd)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/tiny-hat-e1dd
```

A live public deployment of this template is available at [https://tiny-hat-e1dd.templates.workers.dev](https://tiny-hat-e1dd.templates.workers.dev)
